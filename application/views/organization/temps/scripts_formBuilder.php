...
<script src="<?php echo base_url('assets/formBuilder/js/vendor.js')?>"></script>
<script src="<?php echo base_url('assets/formBuilder/js/form-builder.min.js')?>"></script>
<script src="<?php echo base_url('assets/formBuilder/js/form-render.min.js')?>"></script>
<script src="<?php echo base_url('assets/formBuilder/jquery.rateyo.min.js')?>"></script>
<script src="<?php echo base_url('assets/formBuilder/js/demo.js')?>"></script>

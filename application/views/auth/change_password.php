...
<head>
    ...
    <title>Ebursary :: Organization Change Password</title>
                            ...
                            <div class="panel-body">
                                ...
                                <form method="post" action="<?php echo base_url('auth/reset_password')?>">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="signup-field-color" name="password"  required placeholder="Enter New Password" autocomplete="false">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control" id="signup-field-color" name="password2"  required placeholder="Confirm  Password" autocomplete="false">
                                    </div>
                                    <div class="form-group">

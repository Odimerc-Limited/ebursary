...
<head>
    ...
    <title>Ebursary :: Organization Sign Up</title>
...
<body style="background-color: #eceef1;">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-8 col-lg-offset-4 col-md-offset-4 col-sm-offset-4 col-xs-offset-2 " id="signup-logo">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <?php }?>
                                    <form method="post" action="<?php echo base_url('auth/register_organization')?>">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="signup-field-color" name="name" required placeholder="Enter Organization Name">
                                        </div>
                                        <div class="form-group">
                                            <select class="form-control" name="country" id="signup-field-color">
                                                <option value="">Select Organization Country</option>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="signup-field-color" name="person_name" required placeholder="Enter Contact Person Name">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control" id="signup-field-color" name="password_conf"  required placeholder="Confirm Password" autocomplete="false">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="text-center">
                                                <a href="<?php echo base_url('auth/org_login')?>">

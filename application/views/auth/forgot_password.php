                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default mdl-shadow--2dp">
                            <div class="panel-body">
                                ...
                                <?php }?>
                                <form method="post" action="<?php echo base_url('auth/forgot_pass')?>">
                                    <div class="form-group">
                                        <input type="email" class="form-control" id="signup-field-color" name="email" required placeholder="Enter Your Email">
                                    </div>
                                    <div class="form-group">
                                        <button class="mdl-button mdl-button--raised mdl-color--accent mdl-color-text--white mdl-js-button mdl-js-ripple-effect" style="width: 49%;">
                                            <i class="fa fa-share-square-o"></i>
                                            &nbsp;
                                            Submit
                                        </button>
                                        <a href="<?php echo base_url('auth/org_login')?>" class="mdl-button mdl-button--raised mdl-color--primary mdl-color-text--white mdl-js-button mdl-js-ripple-effect" style="width: 50%;">
